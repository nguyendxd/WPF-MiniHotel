...
{
    public partial class PRN221_Spr24_AS1Context : DbContext
    {
        public PRN221_Spr24_AS1Context()
        {
        }

        public PRN221_Spr24_AS1Context(DbContextOptions<PRN221_Spr24_AS1Context> options)
            : base(options)
        {
        }
